	...
	<div class="main">
			...
			<div class="card">
			  <div class="card-header">
			    <h3 class="float-left">Create Data Produk</h3>
              ...
              <form action="index.php?page=produk&aksi=store" method="POST">
                        ...
                        <div class="row mt-2">
                            <div class="col">
                                ...
                                <input type="text" name="level_pedas" placeholder="Masukkan Level Produk" class="form-control" required>
                             </div>

                             <div class="col">
                                <label for="">Berat : </label>
                                <input type="text" name="berat_produk" placeholder="Masukkan Berat Produk" class="form-control" required>
                             </div>

                             <div class="col">
                                <label for="">Stock :</label>
                                <input type="text" name="stok" placeholder="Masukkan Stock Produk" class="form-control" required>
                            </div>
