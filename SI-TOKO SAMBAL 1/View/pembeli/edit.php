	...
	<div class="main">
			...
			<div class="card">
			  <div class="card-header">
			    <h3 class="float-left">Edit Data Pembeli</h3>
              ...
              <form action="index.php?page=pembeli&aksi=update" method="POST">
			  			<input type="hidden" name="id_pembeli" value="<?= $data['id_pembeli'] ?>" required>
                        <div class="row">
                            <div class="col">
                                <label for="">Nama Pembeli :</label>
                                <input type="text" name="nama_pembeli" placeholder="Masukkan Nama Pembeli" class="form-control" value="<?= $data['nama_pembeli'] ?>" required>
                            </div>

                            <div class="col">
                                <label for="">No Telphone :</label>
                                <input type="number" name="no_telp" placeholder="Masukkan No Telepone" class="form-control" value="<?= $data['no_telp'] ?>" required>
                            </div>
                        </div>
						<div class="row mt-2">
							<div class="col">
							<label for="">Alamat Pembeli :</label>
                                <input type="text" name="alamat" placeholder="Masukkan Alamat Pembeli" class="form-control" value="<?= $data['alamat'] ?>" required>
							</div>
						</div>
